...
class ConvertToCnf:
    ...
    def __init__(self, grammar_file_path):
        rules = nltk.data.load('file://' + grammar_file_path, 'text')
...
def main():
    ...
    parser.add_argument('grammar_file', type=str, help='the name of the file containing a context free grammar.')
    ns = parser.parse_args()

    # Input Validation:
    eprint('Grammar File: ', ns.grammar_file)
    converter = ConvertToCnf(ns.grammar_file)
    converter.Convert()
